    ...
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          <span class="text-[#00ff9d] text-xl sm:text-2xl font-bold font-mono">WORLDS</span>
        </div>
        ...
        <div class="flex items-center gap-2 sm:gap-4">
          <button @click="openMentionsModal" class="text-gray-300 hover:text-[#00ff9d] transition-colors duration-200 hidden sm:block">
            <AtSign class="w-5 h-5 sm:w-6 sm:h-6" />
          </button>
          <button @click="openNotificationModal" class="text-gray-300 hover:text-[#00ff9d] transition-colors duration-200 hidden sm:block">
